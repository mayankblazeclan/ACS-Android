...
class AuthenticationForWebviewInterceptor implements Interceptor {
...
//    String fields = "gempakfaq" + ":" + "gempakfaq";
    try {
      ...
      String userName = Utilities
          .encrypt(AppConstants.GEMPAK_RANDOM_DATA, AppConstants.IV, AppConstants.TEXT_HOTSPOT_WEBVIEW_CHECKER_USER);
      String password = Utilities
              .encrypt(AppConstants.GEMPAK_RANDOM_DATA, AppConstants.IV, AppConstants.TEXT_HOTSPOT_WEBVIEW_CHECKER_PASS);
